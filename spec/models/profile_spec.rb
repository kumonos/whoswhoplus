...
describe Profile do
  ...
  describe 'Public Instance Methods' do
    ...
    describe '#name_with_link' do
      it { expect(build(:profile, fb_id: 'youcune', name: 'なかにしゆう').name_with_link).to eq '<a href="https://fb.me/youcune" target="_blank">なかにしゆう</a>' }
    end

    describe '#facebook_url' do
      it { expect(build(:profile, fb_id: 'youcune').facebook_url).to eq 'https://fb.me/youcune' }
    end
